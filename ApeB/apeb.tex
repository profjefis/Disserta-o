...
\begin{quadro}[ht]
	...
	\begin{tabular}{@{}ll@{}}
		...
		Melhorou o desempenho                           & O jogo estava um pouco lento            \\
		Facilitou a compreensão                       & Premiação apenas para os melhores \\
		...
		Melhorou a dinâmica                             & Os diálogos passavam rápido      \\
		Jogo bem elaborado e explicativo                & Termos muito complexos            \\
		A interação com o jogo facilitou o entendimento & Alguns \textit{bugs}                       \\
		Modo de aprendizado mais rápido e divertido     &                                   \\
		Prendeu a atenção                               &                                   \\
		Despertou interesse no aprendizado              &                                   \\
		Facilitou a memorização de termos mais complexos &                                   \\ \bottomrule
	\end{tabular}
\end{quadro}
