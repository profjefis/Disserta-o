...
\renewcommand{\quadroname}{\MakeUppercase{quadro}}
\renewcommand{\listquadroname}{Lista de Quadros} % Forçar texto na

% Forçar texto na Lista de Quadros
%\usepackage{natbib}
...
\renewcommand\numberline[1]{\MakeUppercase{quadro #1} - }
\listofquadros
