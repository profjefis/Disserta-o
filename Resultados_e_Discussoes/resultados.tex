...
\subsection{Análise das Aplicações do Jogo}\label{subsec:análise_aula_3}
\subsection{Discussões sobre o Vídeo: \aspas{O Discreto Charme das Partículas Elementares}}\label{subsec:análise_aula_4_5}
\subsection{Análise das Aulas Expositivas e Dialogadas}\label{subsec:análise_aula_6_7}
